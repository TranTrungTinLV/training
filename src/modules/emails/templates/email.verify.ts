export const templateEmail = (code: string) => {
  ...
  * {
  ...
  <table id="u_content_heading_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; ">Below is your code to recover your password, absolutely do not share this code with anyone:</h1>
        <div align="center">
              <h1 style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">${code}</span></h1>
        </div>
        </td>
      </tr>
    </tbody>
